                ...
                <div className="width-profile">
                    <div className="column-kiri-profile">
                        ...
                        <p className="deskripsi-profile">
                            Nama lengkap saya Mohamad Ridwan Apriyadi. Dalam satu tahun terakhir, saya fokus pengembangan dalam aplikasi e-commerce, dengan fokus pada pengoptimalan performa rendering antarmuka pengguna dan menciptakan pengalaman pengguna yang cepat, responsif dan modern. <br /><br />Dengan menerapkan prinsip Clean Code, hal ini yang dapat memotivasi saya untuk selalu menganalisis kode dan mencegah kode logic atau komponen yang duplikasi. Dari motivasi ini, mendorong saya untuk selalu berpikir dalam teknis di setiap kasus.
                        </p>
