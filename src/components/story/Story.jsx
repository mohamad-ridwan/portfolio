            ...
            <div className="story" id='story'>
                <div className="width-story">
                    ...
                    <div className='deskripsi-panjang-story'>
                        <h3>Cerita di Balik Project Storefront</h3>
                        <div style={{
                            display: 'flex',
                            width: '100%',
                            maxWidth: '300px',
                        ...
                        <span>
                            Dalam project <strong>Storefront</strong> ini, saya begitu dapat pengalaman dalam memperhatikan struktur folder dan bagaimana menyesuaikannya dengan fitur rendering di Next.js App Router. Saya berusaha membuat arsitektur folder yang jelas dan modular, agar setiap bagian dari aplikasi bisa dioptimalkan dengan cara terbaik.
                        </span>
                        <span>
                        ...
                        <span>
                            Dengan pendekatan ini, saya ingin memastikan bahwa setiap pengembang yang bekerja dengan project ini bisa dengan mudah memahami alurnya dan langsung fokus pada pengembangan fitur, tanpa harus memikirkan struktur yang rumit.
                        </span>
